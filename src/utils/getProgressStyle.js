...
export const getProgressStyle = (perc, fields) => {
  switch (true) {
    ...
    case perc >= 100 && perc < 126: return {icon: DriverIcon, style: {backgroundColor: '#ffda44'}}
    ...
    case perc >= 6  && perc < 31: return {icon: SchoolboyIcon, style: {backgroundColor: '#ff5400', color: 'white', right: fields === 2 ? '-15px' : '-30px'}}
    case perc >= 0  && perc < 6: return {icon: SchoolboyIcon, style: {backgroundColor: '#ff5400', color: 'white', right: '-45px'}}
